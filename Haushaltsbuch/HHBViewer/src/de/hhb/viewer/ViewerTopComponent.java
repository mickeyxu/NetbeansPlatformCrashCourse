...
public final class ViewerTopComponent extends TopComponent implements ExplorerManager.Provider {
    ...
    private ExplorerManager controller = new ExplorerManager();
    ...
    public ViewerTopComponent() {
        ...
        // Asynchronous = true: only read the children nodes when expanded;
        Children accountBookChildren = Children.create(new AccountBookFactory(), true);
        
        AbstractNode rootNode = new AbstractNode(accountBookChildren);
        rootNode.setDisplayName("All Accounts");
